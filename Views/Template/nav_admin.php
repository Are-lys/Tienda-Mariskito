    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <?php if (!empty($_SESSION['permisos'][1]['r'])) { ?>
                <li>
                    <a class="app-menu__item" href="<?= base_url(); ?>/dashboard">
                        ...
                        <span class="app-menu__label">Estadísticas De Venta</span>
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if (!empty($_SESSION['permisos'][10]['r']) || !empty($_SESSION['permisos'][11]['r'])) { ?>
                <li class="treeview">
                    <a class="app-menu__item" href="#" data-toggle="treeview">
                        <i class="app-menu__icon fa fa-archive" aria-hidden="true"></i>
                    ...
                    <ul class="treeview-menu">
                        <?php if (!empty($_SESSION['permisos'][10]['r'])) { ?>
                            <li><a class="treeview-item" href="<?= base_url(); ?>/ventasMensuales"><i class="icon fa fa-circle-o"></i> Últimos Pedidos</a></li>
                        <?php } ?>
                        <?php if (!empty($_SESSION['permisos'][11]['r'])) { ?>
                            <li><a class="treeview-item" href="<?= base_url(); ?>/comprobantesVentas"><i class="icon fa fa-circle-o"></i> Últimos Pedidos</a></li>
                        <?php } ?>
                    </ul>
                </li>
            <?php } ?>
