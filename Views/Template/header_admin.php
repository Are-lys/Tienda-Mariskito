...
<html lang="es">
  <head>
    <link rel="icon" type="image/ong" href="<?= media(); ?>/images/logo-mariskito.png">
    <meta charset="utf-8">
    <meta name="description" content="MARISKITO">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">MARISKITO</a>
