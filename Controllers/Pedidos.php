...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small>MARISKITO</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - MARISKITO";
		$data['page_title'] = "PEDIDO <small>MARISKITO</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - MARISKITO";
	...
	public function setReembolso(){
		if($_POST){
			if($_SESSION['permisosMod']['u'] and $_SESSION['userData']['idrol'] != RCLIENTES){
				...
				//var_dump($requestTransaccion); die();
