<?php 
	...
	class Dashboard extends Controllers{
		...
		{
			$data['page_id'] = 2;
			$data['page_tag'] = "Estadísticas De Venta - MARISKITO";
			$data['page_title'] = "Estadísticas De Venta - MARISKITO";
		...
		public function ventasmenualesreporte(){
			if($_POST){
			//	$grafica = "tipoPagoMes";
				$nFecha = str_replace(" ","",$_POST['fecha']);
				$arrFecha = explode('-',$nFecha);
				...
				$anio = $arrFecha[1];
				$pagos = $this->model->selectventasmes($anio,$mes);
				$script = getFile("Template/Modals/reporteventasmes",$pagos);
				echo $script;
				die();
			}
		}
